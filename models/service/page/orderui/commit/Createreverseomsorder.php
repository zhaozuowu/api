<?php
/**
 * @name Createreverseomsorder.php
 * @desc Createreverseomsorder.php
 * @author yu.jin03@ele.me
 */
class Service_Page_Orderui_Commit_Createreverseomsorder extends Wm_Lib_Wmq_CommitPageService
{
    /**
